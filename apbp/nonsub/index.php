...
?>
    ...
    <body>
        ...
        <table class="table" id="pupuksub">
            ...
            $no = 1;
            $query = mysqli_query($conn, 'SELECT * FROM nonsub');
        ...
        <a href="../nonsub/show.php"><button type="button" class="bx bxs-file-plus"> tambah</button></a>
        <br><br><br>
        <div class="tb">
